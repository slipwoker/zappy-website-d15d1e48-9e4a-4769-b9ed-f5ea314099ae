    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הבית של רביבו משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'd15d1e48-9e4a-4769-b9ed-f5ea314099ae',
                    name: data.name || '',
                    email: data.email || '',
